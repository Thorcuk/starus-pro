...
.addField(`• ${PREFIX}**afk**                `,`**AFK moduna geçersiniz.**`)
...
.addField(`• ${PREFIX}**liderlik-tablosu**    `,`**Sunucudaki En yüksek seviyeleri gösterir.**`)
.addField(`• ${PREFIX}**seviyem**            `,`**Kendi Seviyeni gösterir.**`)
